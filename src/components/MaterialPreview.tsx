      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center relative select-none">
          ...
          <div className="relative w-full overflow-hidden py-6">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-slate-50 via-slate-50/80 to-transparent z-10 pointer-events-none"></div>
            <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-slate-50 via-slate-50/80 to-transparent z-10 pointer-events-none"></div>
            ...
            <div className="w-full overflow-hidden">
              ...
              >
                {duplicatedMaterials.map((material, idx) => (
                  <div
                    key={idx}
                    className="w-[300px] md:w-[380px] aspect-[3/4] flex-shrink-0 bg-white rounded-3xl overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.08)] border border-slate-100 hover:shadow-[0_20px_50px_rgba(3,157,31,0.15)] transition-all duration-300 transform hover:-translate-y-1.5 hover:border-[#07b407]/30"
                  >
                    <img
                      src={material.image}
                      alt={material.title}
          ...
          <div className="mt-8 mx-6 flex flex-wrap justify-center gap-5 items-center text-xs text-slate-500 font-medium bg-white px-6 py-3 rounded-full border border-slate-100 shadow-xs">
